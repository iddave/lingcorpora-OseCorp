...
#language = 'ossetics_digor'
#
results = 'http://corpus.ossetic-studies.org/search/results.php' #Ossetic
#results = 'http://corpus-digor.ossetic-studies.org/search/results.php' #Digor
